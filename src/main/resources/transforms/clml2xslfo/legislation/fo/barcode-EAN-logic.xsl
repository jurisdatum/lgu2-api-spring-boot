...
<!-- =========================================================== -->
<!-- This stylesheet calls a named template that draw barcodes   -->
<!-- using EAN-13, EAN-8, UPC-A, or UPC-E encoding scheme. The   -->
<!-- output format depends on the specific drawing component     -->
<!-- that must be imported along with tis template. Currently    -->
<!-- available are "barcode-EAN-FO.xsl" for XSL Formatting       -->
<!-- Objects and "barcode-EAN-SVG.xsl" for SVG.                  -->
<!-- =========================================================== -->
...
<!-- "draw-barcode-EAN" from the imported stylesheet (output     -->
<!-- format specific). If the length of the input string does    -->
<!-- not match the specified barcode type or the barcode type    -->
<!-- is invalid, "draw-error-message" template is called from    -->
<!-- the imported stylesheet. It is expected that this template  -->
<!-- generates a box with an error message. Moreover, diagnostic -->
<!-- messages are sent to console via <xsl:message>.             -->
<!-- =========================================================== -->
