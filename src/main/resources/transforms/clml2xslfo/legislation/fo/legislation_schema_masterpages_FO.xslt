	...
	<fo:layout-master-set>
		...
		<fo:simple-page-master master-name="footer-only-page" page-height="{$g_dblPageHeight}pt" page-width="{$g_dblPageWidth}pt"> 
			<xsl:choose>
				<xsl:when test="$g_strDocType = 'NorthernIrelandAct'">
					<fo:region-body margin-top="130pt" margin-bottom="90pt" margin-left="108pt" margin-right="108pt"/>
					<fo:region-before extent="110pt" display-align="before" region-name="footer-only-before"/>
				...
				<xsl:when test="$g_strDocClass = $g_strConstantSecondary">
					<fo:region-body margin-top="90pt" margin-bottom="72pt" margin-left="90pt" margin-right="90pt"/>
					<fo:region-before extent="110pt" display-align="before" region-name="footer-only-before"/>
					<fo:region-after extent="72pt" display-align="before" region-name="footer-only-after"/>					
				</xsl:when>
				<xsl:otherwise>
					<fo:region-body margin-top="130pt" margin-bottom="72pt" margin-left="90pt" margin-right="90pt"/>
					<fo:region-before extent="110pt" display-align="before" region-name="footer-only-before"/>
					<fo:region-after extent="72pt" display-align="before" region-name="footer-only-after"/>					
				</xsl:otherwise>
			</xsl:choose>
		...
		<fo:simple-page-master master-name="even-page" page-height="{$g_dblPageHeight}pt" page-width="{$g_dblPageWidth}pt">
			<xsl:choose>
				<xsl:when test="$g_strDocType = 'NorthernIrelandAct'">
					<fo:region-body margin-top="130pt" margin-bottom="90pt" margin-left="108pt" margin-right="108pt"/>
					<fo:region-before extent="110pt" display-align="before" region-name="even-before"/>
		...
		<fo:simple-page-master master-name="even-page-unapplied" page-height="{$g_dblPageHeight}pt" page-width="{$g_dblPageWidth}pt">
			<xsl:choose>
				<xsl:when test="$g_strDocType = 'NorthernIrelandAct'">
				...
				<xsl:otherwise>
					<fo:region-body margin-top="72pt" margin-bottom="72pt" margin-left="90pt" margin-right="90pt"/>
					<fo:region-before extent="90pt" display-align="before" region-name="even-before"/>
					<fo:region-after extent="72pt" display-align="before" region-name="even-after"/>
				</xsl:otherwise>
			</xsl:choose>
		</fo:simple-page-master>			
		...
		<fo:simple-page-master master-name="even-page-first" page-height="{$g_dblPageHeight}pt" page-width="{$g_dblPageWidth}pt">
			<xsl:choose>
				<xsl:when test="$g_strDocType = 'NorthernIrelandAct'">
					<fo:region-body margin-top="130pt" margin-bottom="90pt" margin-left="108pt" margin-right="108pt"/>
					<fo:region-before extent="110pt" display-align="before" region-name="even-before-first"/>
					<fo:region-after extent="72pt" display-align="before" region-name="even-after"/>
				</xsl:when>
				<xsl:when test="$g_strDocClass = $g_strConstantSecondary">
					<fo:region-body margin-top="130pt" margin-bottom="72pt" margin-left="90pt" margin-right="90pt"/>
		...
		<fo:simple-page-master master-name="odd-page" page-height="{$g_dblPageHeight}pt" page-width="{$g_dblPageWidth}pt">
			<xsl:choose>
				<xsl:when test="$g_strDocType = 'NorthernIrelandAct'">
					<fo:region-body margin-top="130pt" margin-bottom="90pt" margin-left="108pt" margin-right="108pt"/>
					<fo:region-before extent="110pt" display-align="before" region-name="odd-before"/>
		...
		<fo:simple-page-master master-name="odd-page-unapplied" page-height="{$g_dblPageHeight}pt" page-width="{$g_dblPageWidth}pt">
			<xsl:choose>
				<xsl:when test="$g_strDocType = 'NorthernIrelandAct'">
					<fo:region-body margin-top="130pt" margin-bottom="90pt" margin-left="108pt" margin-right="108pt"/>
					<fo:region-before extent="110pt" display-align="before" region-name="odd-before"/>
		...
		<fo:simple-page-master master-name="odd-page-first" page-height="{$g_dblPageHeight}pt" page-width="{$g_dblPageWidth}pt">
			<xsl:choose>
				<xsl:when test="$g_strDocType = 'NorthernIrelandAct'">
					<fo:region-body margin-top="130pt" margin-bottom="90pt" margin-left="108pt" margin-right="108pt"/>
					<fo:region-before extent="110pt" display-align="before" region-name="odd-before-first"/>
					<fo:region-after extent="72pt" display-align="before" region-name="odd-after"/>	
				</xsl:when>
				<xsl:when test="$g_strDocClass = $g_strConstantSecondary">
					<fo:region-body margin-top="130pt" margin-bottom="72pt" margin-left="90pt" margin-right="90pt"/>
		...
		<!-- Unapplied effects sequence of pages -->
		<fo:page-sequence-master master-name="unapplied-effects-sequence">
			<fo:repeatable-page-master-alternatives>
				<fo:conditional-page-master-reference master-reference="odd-page-unapplied" odd-or-even="odd"/>					
				<fo:conditional-page-master-reference master-reference="even-page-unapplied" odd-or-even="even"/>
			</fo:repeatable-page-master-alternatives>
		</fo:page-sequence-master>		
