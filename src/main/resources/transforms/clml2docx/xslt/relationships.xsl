...
<xsl:function name="local:resource-ref-is-in-footnote" as="xs:boolean">
	...
	<xsl:choose>
		...
		<xsl:otherwise>
		   	<xsl:sequence select="exists($e/ancestor::Footnote[local:footnote-has-ref(.)])" />
		</xsl:otherwise>
	</xsl:choose>
</xsl:function>
...
<xsl:template name="relationships">
	<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">
		...
		<!-- hyperlinks -->
		<xsl:for-each select="//Citation[empty(ancestor::Footnote[local:footnote-has-ref(.)]) and empty(ancestor::MarginNotes) and empty(ancestor::Commentary) and exists(@URI)]">
		...
		<xsl:for-each select="//ExternalLink[empty(ancestor::Footnote[local:footnote-has-ref(.)]) and empty(ancestor::MarginNotes) and empty(ancestor::Commentary) and exists(@URI)]">
			<Relationship xmlns="http://schemas.openxmlformats.org/package/2006/relationships" Id="{ generate-id(.) }" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/hyperlink" Target="{ @URI }" TargetMode="External" />
		</xsl:for-each>
		<xsl:for-each select="//CitationSubRef[empty(ancestor::Footnote[local:footnote-has-ref(.)]) and empty(ancestor::MarginNotes) and empty(ancestor::Commentary) and exists(@URI)]">
			<Relationship xmlns="http://schemas.openxmlformats.org/package/2006/relationships" Id="{ generate-id(.) }" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/hyperlink" Target="{ @URI }" TargetMode="External" />
		</xsl:for-each>
	</Relationships>
</xsl:template>
...
<xsl:template name="footnote-relationships">
	<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">
		...
		<xsl:for-each select="//Footnote[local:footnote-has-ref(.)]//Citation[exists(@URI)]">
			<Relationship xmlns="http://schemas.openxmlformats.org/package/2006/relationships" Id="{ generate-id(.) }" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/hyperlink" Target="{ @URI }" TargetMode="External" />
		</xsl:for-each>
		<xsl:for-each select="//Footnote[local:footnote-has-ref(.)]//ExternalLink[exists(@URI)]">
			<Relationship xmlns="http://schemas.openxmlformats.org/package/2006/relationships" Id="{ generate-id(.) }" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/hyperlink" Target="{ @URI }" TargetMode="External" />
		</xsl:for-each>
		<xsl:for-each select="//Footnote[local:footnote-has-ref(.)]//CitationSubRef[exists(@URI)]">
			<Relationship xmlns="http://schemas.openxmlformats.org/package/2006/relationships" Id="{ generate-id(.) }" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/hyperlink" Target="{ @URI }" TargetMode="External" />
		</xsl:for-each>
		...
		<xsl:for-each select="/Legislation/Commentaries/Commentary//Citation[exists(@URI)]">
			<Relationship xmlns="http://schemas.openxmlformats.org/package/2006/relationships" Id="{ generate-id(.) }" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/hyperlink" Target="{ @URI }" TargetMode="External" />
		</xsl:for-each>
		<xsl:for-each select="/Legislation/Commentaries/Commentary//ExternalLink[exists(@URI)]">
			<Relationship xmlns="http://schemas.openxmlformats.org/package/2006/relationships" Id="{ generate-id(.) }" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/hyperlink" Target="{ @URI }" TargetMode="External" />
		</xsl:for-each>
		<xsl:for-each select="/Legislation/Commentaries/Commentary//CitationSubRef[exists(@URI)]">
			<Relationship xmlns="http://schemas.openxmlformats.org/package/2006/relationships" Id="{ generate-id(.) }" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/hyperlink" Target="{ @URI }" TargetMode="External" />
		</xsl:for-each>
	</Relationships>
</xsl:template>
