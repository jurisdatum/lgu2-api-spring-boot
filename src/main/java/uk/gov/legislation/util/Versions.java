...
public class Versions {
    ...
    public static boolean isVersionLabel(String s) {
        if (s.equals("enacted")) return true;
        if (s.equals("made")) return true;
        if (s.equals("created")) return true;
        if (s.equals("adopted")) return true;
        if (s.equals("current")) return true;
        if (s.equals("prospective")) return true;
        return date.matcher(s).matches();
    }
    ...
    public static final Comparator<String> COMPARATOR =
            Comparator.comparingInt(Versions::rank).thenComparing(Comparator.naturalOrder());
}
