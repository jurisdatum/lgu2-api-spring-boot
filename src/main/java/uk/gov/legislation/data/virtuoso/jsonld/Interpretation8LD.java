...
public class Interpretation8LD {
    ...
    @JsonProperty
    public ItemLD interpretationOf;
    ...
    public static Interpretation8LD convert(ObjectNode node) {
        return Graph.mapper.convertValue(node, Interpretation8LD.class);
    }
