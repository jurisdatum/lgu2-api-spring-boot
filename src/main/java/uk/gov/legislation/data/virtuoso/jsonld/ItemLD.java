...
public class ItemLD {
    ...
    @JsonProperty public URI calendarYear;

    @JsonProperty public URI session;

    @JsonProperty public Integer number;

    @JsonProperty public List<ValueAndLanguage> title;
    ...
    @JsonProperty public List<ValueAndLanguage> citation;
    ...
    @JsonProperty public List<ValueAndLanguage> fullCitation;
    ...
    @JsonProperty public List<ValueAndLanguage> commentaryCitation;
    ...
    @JsonProperty public List<String> interpretation;

    @JsonProperty public List<String> originalLanguageOfText;
    ...
    @JsonProperty public List<ValueAndType> originalLanguageOfTextIsoCode;

    @JsonSetter("originalLanguageOfTextIsoCode")
    public void setOriginalLanguageOfTextIsoCode(JsonNode node) {
        if (node != null && node.isTextual()) {
            this.originalLanguageOfTextIsoCode =
                    Collections.singletonList(ValueAndType.convert(node));
        } else {
