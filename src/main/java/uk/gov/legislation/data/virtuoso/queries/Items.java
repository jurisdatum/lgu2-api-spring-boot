...
public class Items {
    ...
    public Items(Virtuoso virtuoso) {
        this.virtuoso = virtuoso;
    }

    public String makeSparqlQuery(String type, int year, int limit, int offset)
    ...
    public String get(String type, int year, int limit, int offset, String format)
            throws IOException, InterruptedException {
        String query = makeSparqlQuery(type, year, limit, offset);
        return virtuoso.query(query, format);
    }

    public List<Item> get(String type, int year, int limit, int offset)
            throws IOException, InterruptedException {
