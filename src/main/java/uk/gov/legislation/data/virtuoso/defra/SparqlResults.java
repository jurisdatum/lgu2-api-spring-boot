...
public class SparqlResults {
    ...
    @JsonProperty public Results results;

    public static class Results {

        @JsonProperty public List<Item> bindings;
    }

    public static class Item {

        @JsonProperty public Value item;

        @JsonProperty public Value year;

        @JsonProperty public Value number;

        public Value title;

        @JsonProperty public Value typeLabel;

        @JsonProperty public Value reviewDate;
    }
    ...
    public List<SimpleItem> simplified() {
        return results.bindings.stream()
                .map(
                        item -> {
    ...
    public static class SimpleItem {
        ...
        @JsonProperty public LocalDate review;
    }
}
