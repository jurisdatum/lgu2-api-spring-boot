...
@Parameter(
        ...
        examples = {
            ...
            @ExampleObject(
                    ...
                    summary = "Agriculture and Rural Development"),
            @ExampleObject(
                    value = "animal-health-and-welfare",
                    summary = "Animal Health and Welfare"),
            @ExampleObject(value = "marine-and-fisheries", summary = "Marine and Fisheries"),
            @ExampleObject(
                    value = "plant-health-and-quality",
                    summary = "Plant Health and Quality"),
            @ExampleObject(
                    value = "food-labelling-and-composition",
                    summary = "Food Labelling and Composition"),
