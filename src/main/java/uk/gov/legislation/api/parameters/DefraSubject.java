...
@Parameter(
        ...
        examples = {
            ...
            @ExampleObject(
                    value = "notice-order-direction-declaration",
                    summary = "Notice/Order/Direction/Declaration"),
            ...
            @ExampleObject(
                    value = "incoming-fees-and-payments",
                    summary = "Incoming Fees and Payments"),
            ...
            @ExampleObject(
                    value =
                            "non-criminal-penalties-including-administrative-penalties-and-civil-sanctions",
                    summary =
                            "Non-Criminal Penalties (Including Administrative Penalties and Civil"
                                    + " Sanctions)"),
