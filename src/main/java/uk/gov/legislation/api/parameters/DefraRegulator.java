...
@Parameter(
        ...
        examples = {
            ...
            @ExampleObject(
                    value = "secretary-of-state-defra",
                    summary = "Secretary of State (Defra)"),
            ...
            @ExampleObject(
                    value = "cefas",
                    summary = "Centre for Environment, Fisheries and Aquaculture Science"),
            @ExampleObject(value = "hse", summary = "Health and Safety Executive"),
            @ExampleObject(
                    value = "ofwat",
                    summary = "Ofwat (Water Services Regulation Authority)"),
