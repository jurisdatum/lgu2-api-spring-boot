...
/**
 * Represents a document associated with a piece of legislation, such as explanatory notes, impact
 * assessments, correction slips, alternative formats, or other supplementary documents. Provides a
 * unified API response format for all types of related documents.
 */
public class AssociatedDocument {
    ...
    @JsonProperty public final URI uri;
    ...
    @Schema(
            description =
                    "Indicates the stage of the development of the legislation to which the Impact"
                        + " Assessment relates, which may be before its development (Consultation),"
                        + " during its development (Development), after the drafting of the"
                        + " document (Final), after its amendment in Parliament (Enactment) or"
                        + " after its enactment (Post-Implementation)",
            allowableValues = {
                "Consultation",
                "Development",
                "Final",
