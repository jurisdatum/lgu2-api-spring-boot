...
public class DocumentController implements DocumentApi {
    ...
    @Override
    public ResponseEntity<StreamingResponseBody> getDocumentClml(
    ...
    @Override
    public ResponseEntity<StreamingResponseBody> getImpactAssessmentClml(int year, int number)
            throws Exception {
    ...
    public static final MediaType APPLICATION_AKN_XML =
            MediaType.parseMediaType("application/akn+xml;charset=UTF-8");

    @Override
    public ResponseEntity<StreamingResponseBody> getDocumentAkn(
            String type, int year, int number, Optional<String> version, Locale locale) {
        return fetchAndTransformToStream(
                type,
                Integer.toString(year),
    ...
    @Override
    public ResponseEntity<StreamingResponseBody> getDocumentHtml(
            String type, int year, int number, Optional<String> version, Locale locale) {
        return fetchAndTransformToStream(
                type,
                Integer.toString(year),
    ...
    @Override
    public ResponseEntity<Document> getDocumentJson(
            String type, int year, int number, Optional<String> version, Locale locale)
            throws Exception {
        return fetchAndTransform(
                type, Integer.toString(year), number, version, locale, transforms::clml2document);
    }
    ...
    public ResponseEntity<Document> getDocumentJson(
        ...
        String regnalYear = String.join("/", monarch, years);
        return fetchAndTransform(
                type, regnalYear, number, version, locale, transforms::clml2document);
    }

    @Override
    public ResponseEntity<Associated> getImpactAssessmentJson(int year, int number)
            throws Exception {
    ...
    public static final MediaType PDF =
            new MediaType(MediaType.APPLICATION_PDF, StandardCharsets.UTF_8);

    @Override
    public ResponseEntity<StreamingResponseBody> pdf(
            String type, int year, int number, Optional<String> version, Locale locale) {
        return fetchAndTransformToStream(
                type, Integer.toString(year), number, version, locale, transforms::clml2pdf, PDF);
    }
    ...
    public ResponseEntity<StreamingResponseBody> pdf(
        ...
        String regnalYear = String.join("/", monarch, years);
        return fetchAndTransformToStream(
                type, regnalYear, number, version, locale, transforms::clml2pdf, PDF);
    }
    ...
    public interface Transform<T> {
        T apply(InputStream t) throws Exception;
    }
