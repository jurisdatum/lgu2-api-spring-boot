package uk.gov.legislation.endpoints.document.helper;
...
public class ContentsHelper {
    ...
    public ContentsHelper(Legislation legislationRepository, Clml2Akn clmlToAknTransformer, Simplify simplifier) {
    ...
    public String transformToAkn(String clmlContent) {
        try {
            ...
            throw new TransformationException("Transformation to AKN format failed");
        }
    }
    ...
    public TableOfContents simplifyToTableOfContents(String clmlContent) {
        try {
            ...
            throw new TransformationException("Simplification to JSON format failed");
        }
    }
}
