...
public class AssociatedController {
    ...
    public String xml(@PathVariable @Year int year, @PathVariable @Number int number)
    ...
    public Associated json(@PathVariable @Year int year, @PathVariable @Number int number)
            throws IOException, InterruptedException {
        return marklogic
                .get(year, number)
