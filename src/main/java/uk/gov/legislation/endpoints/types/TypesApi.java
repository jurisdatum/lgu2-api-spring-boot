...
@Tag(
        name = "Document types",
        description = "APIs for fetching document types and their country-specific applicability")
public interface TypesApi {
    ...
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
                        description = "Successfully fetched document types",
                        content =
                                @Content(
    ...
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
                        description = "Successfully fetched country-specific document types",
                        content =
                                @Content(
                                        mediaType = MediaType.APPLICATION_JSON_VALUE,
                ...
                @ApiResponse(
                        responseCode = "400",
                        description = "Unrecognized country",
                        content =
                                @Content(
                                        mediaType = MediaType.APPLICATION_JSON_VALUE,
