...
/**
 * Custom extension functions for the Saxon processor These functions provide information about the
 * images that belong to the Legislation item
 */
public class SaxonExtensionFunctions {
    ...
    /** Returns the width of one of the images included in the document */
            ...
            return new ExtensionFunctionCall() {
                ...
                public Sequence call(XPathContext context, Sequence[] arguments)
                    ...
                    Map<String, Resource> cache =
                            ((ObjectValue<Map<String, Resource>>) arguments[1]).getObject();
                    Resource resource;
                    try {
    ...
    /** Returns the height of one of the images included in the document */
    ...
    /** Returns the media type of one of the images included in the document */
        ...
        public ExtensionFunctionCall makeCallExpression() {
            return new ExtensionFunctionCall() {
                ...
                public Sequence call(XPathContext context, Sequence[] arguments)
                    ...
                    if (contentType == null) return EmptySequence.getInstance();
