...
public class LegislationApiDelegate implements Delegate {
    ...
    public Resource fetch(String uri) throws IOException {
        ...
        // rewrite host name for QA/UAT environments, because the links in the CLML don't go to the
        // right
        // environment
        URL url = new URL(uri);
        ...
        if (connection.getResponseCode() == HttpURLConnection.HTTP_MOVED_TEMP
            ...
            if (getAuthenticationMode() == Authentication.BASIC) {
                ...
                String authHeaderValue =
                        "Basic " + new String(encodedAuth, StandardCharsets.US_ASCII);
                connection.setRequestProperty("Authorization", authHeaderValue);
            }
        }
        ...
        if (contentType.equals("binary/octet-stream")) {
            ...
            if (contentType == null) {
                ...
                if (imageReaders.hasNext()) {
                    ...
                    contentType =
                            "image/gif"; // http://www.legislation.gov.uk/uksi/2018/4/images/uksi_20180004_en_001
                }
            }
