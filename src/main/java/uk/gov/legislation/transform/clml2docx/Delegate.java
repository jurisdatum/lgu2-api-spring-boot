...
/**
 * Defines an interface that's used by the conversion function to retrieve source data and
...
public interface Delegate {
    ...
    public static class Resource {
        ...
        int getImageWidth() throws IOException {
            if (image == null) image = ImageIO.read(new ByteArrayInputStream(content));
