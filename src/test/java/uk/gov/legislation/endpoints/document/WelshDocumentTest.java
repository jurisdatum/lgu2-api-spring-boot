...
class WelshDocumentTest {
    ...
    @MockitoSpyBean private Transforms transforms;
    ...
    void setUp() throws Exception {
        ...
        doAnswer(
                        invocation -> {
                            ...
                            String clmlString =
                                    new String(clmlStream.readAllBytes(), StandardCharsets.UTF_8);
                            return transforms.clml2document(clmlString);
                        })
                .when(transforms)
                .clml2document(any(InputStream.class));
    }

    @MockitoBean private Impacts impacts;

    @MockitoBean private UnappliedEffectsFetcher effectsFetcher;
    ...
    void test() throws Exception {
        ...
        mockMvc.perform(
                ...
                .andExpect(
                        content()
                                .json(ExpectedWelshResponseDataCy.DOCUMENT_WELSH_RESPONSE_CY_JSON));
    }
}
