...
class CustomHeadersTest {
    ...
    void testMake(
            String language, Redirect redirect, String expectedVersion, ExpectedHeaders expected) {
        ...
        assertAll(
                ...
                () ->
                        assertEquals(
                                expectedVersion, headers.getFirst(CustomHeaders.VERSION_HEADER)));
    }
    ...
    static Stream<Arguments> provideHeadersTestCases() {
        return Stream.of(
                ...
                Arguments.of("fr", null, null, new ExpectedHeaders(null, null, null)),
                Arguments.of(
                        null,
                        new Redirect("ukpga", "2023", 5, Optional.of("made")),
                        "made",
                        new ExpectedHeaders("ukpga", "2023", "5")),
                Arguments.of(null, null, null, new ExpectedHeaders(null, null, null)));
    }
