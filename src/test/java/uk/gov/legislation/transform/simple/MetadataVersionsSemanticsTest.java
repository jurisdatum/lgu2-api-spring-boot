...
class MetadataVersionsSemanticsTest {
    ...
    @Test
    void versions_finalCurrentOnly_primary_addsEnactedAndProspective()
    ...
    @Test
    void versions_finalCurrentOnly_secondary_addsMadeAndProspective()
            throws SaxonApiException, JacksonException {
    ...
    @Test
    void versions_finalCurrentOnly_ministerialOrder_addsCreatedAndProspective()
            throws SaxonApiException, JacksonException {
        Metadata metadata =
                simplifier.extractDocumentMetadata(FINAL_MINISTERIAL_ORDER_CURRENT_ONLY);
        assertEquals("created", metadata.version());
        assertEquals(List.of("created", "prospective"), metadata.versions().stream().toList());
    }

    @Test
    void versions_finalCurrentOnly_euDirective_addsAdoptedAndProspective()
            throws SaxonApiException, JacksonException {
    ...
    @Test
    void versions_finalCurrentAlongsideDate_ignoresCurrentAndDoesNotAddProspective()
            throws SaxonApiException, JacksonException {
    ...
    @Test
    void versions_finalWithoutHasVersion_addsFirstVersionOnly()
            throws SaxonApiException, JacksonException {
    ...
    @Test
    void version_revisedDocumentWhoseTargetIsNotProspective_usesDctValidDate()
            throws SaxonApiException, JacksonException, IOException {
    ...
    @Test
    void version_revisedFragmentWithProspectiveProvisions_usesProspectiveLabel()
            throws SaxonApiException, JacksonException, IOException {
        String clml =
                UnappliedEffectsHelper.read(
                        "/asp_2025_11/asp-2025-11-part-1-crossheading-reviews-2025-08-07.xml");
    ...
    @Test
    void versions_unversionedProspectiveRevised_withoutCurrent_addsProspectiveLabel()
            throws SaxonApiException, JacksonException {
        Metadata metadata =
                simplifier.extractDocumentMetadata(UNVERSIONED_PROSPECTIVE_REVISED_WITHOUT_CURRENT);
        assertEquals("prospective", metadata.version());
        assertEquals(List.of("enacted", "prospective"), metadata.versions().stream().toList());
    }
    ...
    @Test
    void versions_versionedNonProspectiveFragment_withCurrent_doesNotAddDctValidAsMilestone()
            throws SaxonApiException, JacksonException {
        Metadata metadata =
                simplifier.extractFragmentMetadata(
                        VERSIONED_NON_PROSPECTIVE_FRAGMENT_CURRENT_AND_OLDER_DATE);
        assertEquals("2024-10-01", metadata.version());
        assertEquals(List.of("2024-10-01"), metadata.versions().stream().toList());
    }

    @Test
    void version_unversionedFragment_usesLastFragmentMilestoneNotPayloadDate()
            throws SaxonApiException, JacksonException, IOException {
    ...
    @Test
    void versions_welshFragment_filtersToWelshHasVersionLinksOnly()
            throws SaxonApiException, JacksonException, IOException {
    ...
    @Test
    void versionedWelshFragment_pointInTimeAndDctValidDoNotOverrideFragmentMilestone()
            throws SaxonApiException, JacksonException, IOException {
        Metadata metadata =
                simplifier.extractFragmentMetadata(BilingualFragmentFixtures.welshPointInTime());
    ...
    void versions_unknownLanguageRetainsAllLinks() {
        ...
        assertEquals(
                List.of("made", "2021-02-27", "2022-03-28"), metadata.versions().stream().toList());
    }
    ...
    void versions_stripsRepealedSuffixFromLatestLabel() {
        ...
        assertEquals(
                List.of("enacted", "2001-01-01", "2003-01-01"),
                metadata.versions().stream().toList());
    }
