...
class YearFacetsTest {
    ...
    private static final String EXPECTED_QUERY =
            String.format(
                    ...
                    "?year",
                    BASE_WHERE
                            + " ?item <http://www.legislation.gov.uk/def/legislation/year> ?year .",
                    "?year");

    private record CountExpectation(int year, int count) {}

    private record ValidTestCase(
            String name, String jsonResponse, List<CountExpectation> expectedCounts) {}
    ...
    static Stream<ValidTestCase> validCases() {
        return Stream.of(
                new ValidTestCase(
                        ...
                        """,
                        List.of(new CountExpectation(2021, 15), new CountExpectation(2020, 10))),
                new ValidTestCase(
                        "empty result",
                        """
                            {
                ...
                new ValidTestCase(
                        ...
                        """,
                        List.of(new CountExpectation(2023, 12), new CountExpectation(2019, 8))));
    }
