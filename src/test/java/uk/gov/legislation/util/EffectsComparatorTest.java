...
class EffectsComparatorTest {
    ...
    void testCompareFragmentIds(String id1, String id2, int expectedSign) {
        ...
        assertEquals(
                ...
                String.format(
                        "Expected comparison of '%s' vs '%s' to return %d but got %d",
    ...
    static Stream<Arguments> provideFragmentIdComparisons() {
        return Stream.of(
                ...
                Arguments.of(
                        "part-1-crossheading-bulk-personal-dataset-warrants",
                        "part-1-crossheading-low-or-no-reasonable-expectation-of-privacy",
                        0));
    }
}
