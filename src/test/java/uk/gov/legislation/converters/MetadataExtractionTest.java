...
class MetadataExtractionTest {
    ...
    void versions() throws SaxonApiException, JacksonException {
        ...
        Assertions.assertEquals(
                "2017-01-16", versions.get(1), "Second version should be '2017-01-16'");
        Assertions.assertEquals(
                "2017-03-16", versions.get(2), "Third version should be '2017-03-16'");
        ObjectMapper mapper = new ObjectMapper();
        DocumentMetadata meta = DocumentMetadataConverter.convert(simple.meta);
        String json = mapper.writeValueAsString(meta);
        Assertions.assertTrue(
                json.contains("\"versions\":[\"enacted\",\"2017-01-16\",\"2017-03-16\""));
    }
}
