...
class MonarchConverterTest {
    ...
    static Stream<Arguments> provideMonarchLDInputs() {
        return Stream.of(
                ...
                Arguments.of(
                        newMonarchLD(URI.create("http://example.com/monarch/2"), null, null, null),
                        URI.create("http://example.com/monarch/2"),
                        null,
                        null,
                        null),
                // Case: Empty strings and nulls
                Arguments.of(newMonarchLD(null, "", "", null), null, "", "", null));
    }

    // Helper method to create MonarchLD instances
    private static MonarchLD newMonarchLD(
            URI id, String label, String regnalName, Integer regnalNumber) {
