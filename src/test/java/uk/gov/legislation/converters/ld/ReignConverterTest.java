...
class ReignConverterTest {
    ...
    void testConvert_ReignLD(
        ...
        assertAll(
                ...
                () ->
                        assertEquals(
                                expected.startRegnalYear,
                                actual.startRegnalYear,
                                "Start regnal year mismatch"),
                () ->
                        assertEquals(
                                expected.endRegnalYear,
                                actual.endRegnalYear,
                                "End regnal year mismatch"));
    }
    ...
    static Stream<Arguments> provideReignConversionCases() {
        ...
        return Stream.of(
                ...
                Arguments.of(
                        "Empty monarch list",
                        newReignLD(
                                id, "Label", List.of(), startDate, endDate, regnalStart, regnalEnd),
                        buildExpected(
                                id,
                                "Label",
                                List.of(),
    ...
    private static Reign buildExpected(
            URI uri,
            String label,
            List<String> monarchs,
            LocalDate start,
            LocalDate end,
            Integer startRegnal,
            Integer endRegnal) {
    ...
    private static ReignLD newReignLD(
            URI id,
            String label,
            List<URI> monarchs,
            URI startDate,
