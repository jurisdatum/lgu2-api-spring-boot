...
class DataSetConverterTest {
    ...
    void testConvert(
            ...
            ZonedDateTime expectedCreated,
            ZonedDateTime expectedModified) {
        ...
        return Stream.of(
                ...
                Arguments.of(
                        newDatasetLD(
                                ...
                                List.of(
                                        URI.create(
                                                "http://www.legislation.gov.uk/def/legislation/Regulation")),
                                null,
                                null,
                                null),
                        URI.create("http://www.legislation.gov.uk/id/456"),
    ...
    private static DatasetLD newDatasetLD(
            URI id, List<URI> types, String title, ValueAndType created, ValueAndType modified) {
